...
$sessionDebug = [
    ...
    'line_user_id' => $sessionManager->getLINEUserId() ?? 'not_set',
    'line_display_name' => $sessionManager->getLINEDisplayName() ?? 'not_set',
    'session_data_count' => count($_SESSION),
    'session_keys' => array_keys($_SESSION),
    'is_authenticated' => $sessionManager->isLINEAuthenticated()
];
...
$pictureUrl = $sessionManager->getLINEPictureUrl();
