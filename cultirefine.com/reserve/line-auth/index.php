...
require_once __DIR__ . '/GasApiClient.php';
...
<body>
    ...
    <!-- JavaScriptモジュール（キャッシュ対策のためバージョンパラメータ付き） -->
    <?php $version = time(); // 本番環境では固定のバージョン番号を使用 ?>
    <script type="module" src="./js/core/polyfills.js?v=<?php echo $version; ?>"></script>
    <script type="module" src="./js/core/storage-manager.js?v=<?php echo $version; ?>"></script>
    <script type="module" src="./js/core/app-state.js?v=<?php echo $version; ?>"></script>
    <script type="module" src="./js/core/ui-helpers.js?v=<?php echo $version; ?>"></script>
    <script type="module" src="./js/data/treatment-data.js?v=<?php echo $version; ?>"></script>
    <script type="module" src="./js/data/mock-api.js?v=<?php echo $version; ?>"></script>
    <script type="module" src="./js/data/gas-api.js?v=<?php echo $version; ?>"></script>
    <script type="module" src="./js/components/calendar.js?v=<?php echo $version; ?>"></script>
    <script type="module" src="./js/components/treatment-accordion.js?v=<?php echo $version; ?>"></script>
    <script type="module" src="./js/components/modal.js?v=<?php echo $version; ?>"></script>
    <script type="module" src="./js/screens/patient-selection.js?v=<?php echo $version; ?>"></script>
    <script type="module" src="./js/screens/menu-calendar.js?v=<?php echo $version; ?>"></script>
    <script type="module" src="./js/screens/pair-booking.js?v=<?php echo $version; ?>"></script>
    <script type="module" src="./js/screens/bulk-booking.js?v=<?php echo $version; ?>"></script>
